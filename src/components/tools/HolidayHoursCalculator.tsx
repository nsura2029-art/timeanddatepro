      ...
      <div id="setup-card" className="bg-white rounded-3xl border border-[#e0e0e0] shadow-xl p-6 md:p-8 space-y-6">
        <header className="mb-2">
          <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-slate-500 inline-flex items-center gap-1.5">
            <Calendar size={11} /> HOLIDAY & HOURS INTELLIGENCE
          </span>
          <h1 className="mt-1 text-2xl md:text-3xl font-extrabold tracking-tight text-[#212121]">{t.holidayCalendar}</h1>
          <p className="mt-1 text-sm text-[#616161]">{t.publicHolidays} + {t.workingHours}</p>
        </header>
