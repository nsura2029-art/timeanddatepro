...
export const CITY_DATA: Record<string, CityInfo> = {
  "America/New_York": { name: "New York", country: "United States", timezone: "America/New_York", code: "NYC" },
  "America/Los_Angeles": { name: "Los Angeles", country: "United States", timezone: "America/Los_Angeles", code: "LAX" },
  "America/Chicago": { name: "Chicago", country: "United States", timezone: "America/Chicago", code: "CHI" },
  "Europe/London": { name: "London", country: "United Kingdom", timezone: "Europe/London", code: "LON" },
  "Europe/Berlin": { name: "Berlin", country: "Germany", timezone: "Europe/Berlin", code: "BER" },
  "Europe/Paris": { name: "Paris", country: "France", timezone: "Europe/Paris", code: "PAR" },
  "Asia/Tokyo": { name: "Tokyo", country: "Japan", timezone: "Asia/Tokyo", code: "TYO" },
  "Asia/Shanghai": { name: "Beijing", country: "China", timezone: "Asia/Shanghai", code: "PEK" },
  "Asia/Kolkata": { name: "New Delhi", country: "India", timezone: "Asia/Kolkata", code: "DEL" },
  "Asia/Dubai": { name: "Dubai", country: "United Arab Emirates", timezone: "Asia/Dubai", code: "DXB" },
  "Asia/Singapore": { name: "Singapore", country: "Singapore", timezone: "Asia/Singapore", code: "SIN" },
  "Australia/Sydney": { name: "Sydney", country: "Australia", timezone: "Australia/Sydney", code: "SYD" },
  "Asia/Riyadh": { name: "Riyadh", country: "Saudi Arabia", timezone: "Asia/Riyadh", code: "RUH" },
};
